		...
		<div class="col-md-12 service-list">
			<div class="container">
				...
				foreach ($services as $service){
					?>
				<div class="col-md-4 col-sm-12 service-sec">
					<div class="service-name">
						<div class="service-icon"><img src="<?php echo $service['mhd_service_img']; ?>" alt=""></div>
						<div class="service-title"><h3><?php echo $service['mhd_service_title']; ?></h3></div>
						<div class="service-title">
                            <p><?php echo $service['mhd_service_desc']; ?></p>
                        </div>
					</div>
				</div>
            <?php } ?>
