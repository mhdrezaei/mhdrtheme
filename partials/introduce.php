<section class="introduce">
	<div class="introduce">
		...
		<div class="col-md-12 col-sm-12">
			<div class="col-md-6 col-sm-12 introduce-img">
			...
			<div class="col-md-6 col-sm-12 introduce-text"><svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
...
<p><?php echo $introduce[0]['mhd_introduce_desc'] ?></p>
			</div>
		</div>
	</div>
</section>
